...
export default function View() {
  ...
  return (
    <div className="p-3 space-y-6" ref={containerRef}>
      {cars.map((car) => (
        <div
          key={car._id}
          className="car-card bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200 flex items-start gap-4 p-4"
        >
          {/* Car Image */}
